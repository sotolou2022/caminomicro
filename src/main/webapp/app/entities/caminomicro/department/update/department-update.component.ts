...
import { ILocation } from 'app/entities/caminomicro/location/location.model';
import { LocationService } from 'app/entities/caminomicro/location/service/location.service';
