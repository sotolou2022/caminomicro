...
import com.camino.microservice.domain.JobHistory;
import com.camino.microservice.repository.JobHistoryRepository;
import com.camino.microservice.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.camino.microservice.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "caminomicroJobHistory";
