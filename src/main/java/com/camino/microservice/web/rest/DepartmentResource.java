package com.camino.microservice.web.rest;

import com.camino.microservice.domain.Department;
import com.camino.microservice.repository.DepartmentRepository;
import com.camino.microservice.service.DepartmentService;
import com.camino.microservice.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.camino.microservice.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    private static final String ENTITY_NAME = "caminomicroDepartment";
