...
import com.camino.microservice.domain.Job;
import com.camino.microservice.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.camino.microservice.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobResource {
    ...
    private static final String ENTITY_NAME = "caminomicroJob";
